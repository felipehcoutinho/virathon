...
def central():
    ...
    if (args.call_prodigal_module == True):
        (merged_cds_file,merged_genes_file,merged_gff_file) = call_prodigal(merged_genomes_file)
...
merged_genomes_file = None #'All_Genomic.fasta'
merged_genes_file = None #'All_Genes.fna'
merged_cds_file = None #'All_CDS.faa'
