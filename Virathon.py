...
parser.add_argument("--cds_file", help="File of CDS protein sequences", type =str, default ="NA")
...
def central():
    ...
    if (args.merge_seqs == True):
        ...
        print(f"Merge module not set to True. Using the first genome file ({ genome_files[0]}) as merged file.")
    ...
    index_seqs(genome_files,cds_file,args.rename_seqs, args.out_seq_file,args.merge_seqs)
